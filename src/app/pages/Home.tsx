      ...
      <section>
        <div className="container mx-auto grid place-items-center  sm:h-svh">
          <div className="grid place-items-center font-trebuchet gap-y-8  ">
            <h2 className="font-trebuchet text-center text-primary text-3xl font-semibold">We are Certified SaaS Consultants</h2>
            <p className="font-light text-center text-lg w-11/12 md:w-10/12"><span className="text-primary font-semibold">D4A Cloud ERP Solutions is a SaaS Consulting Partner </span>  certified to help businesses customize, integrate, and implement SaaS products
for a large spectrum of industry. Once your customized system is live and running in your processes, we will train you and your users
about its functionality and also offer first-level customer support and manage relationships.</p>
            <p className="font-light text-center text-lg w-10/12">With more than 10 years of experience in SaaS business, We know just what you need.
D4A is led by experienced business and technology professionals. We have focus on cloud based ERP and CRM solutions. We provide
services of Technology Planning and Deployment, SaaS (Software as a Service) applications deployment, Application Maintenance and
Data Management. We also have expertise on Zoho's industry specific vertical solutions .</p>
            <p className="font-light text-center text-lg w-10/12">With our <span className="text-primary font-semibold">SaaS Consultation services</span>, we help SMBs and enterprises in streamlining and transforming their complex business processes
            while connecting to their customers in a whole anew way.</p>
          </div>
        </div>
      </section>
<section>
...
<Image src={partner1} alt="zoho partner" className="lg:w-[250px] xl:w-[350px]"></Image>
<Image src={partner2} alt="monday partner" className=" lg:w-[250px] w-[704px] xl:w-[350px]"></Image>
<Image src={partner3} alt="tally partner" className=" lg:w-[250px] xl:w-[350px]"></Image>
            </motion.div>
        </div>
      </section>
<section>
      ...
      <section>
        <div className="container mx-auto welcome w-full h-screen mt-20 py-6">
            ...
            <div>
                <h2 className="text-secondary text-center font-roboto text-3xl font-semibold ">Welcome!</h2>
                <p className="text-white text-center text-xs mt-3">Book your appointment in a few simple steps: Choose a service, pick your date and time, and fill in your details. See you soon!</p> 
            </div>
     <div className="hidden xl:block">
     <div className="flex items-start  ml-28 mt-10 ">
            <div className="w-full space-y-10">
                <div className={` ${Tab==1?"border-l-2 border-l-secondary":"border-none"} h-16 w-9/12  flex justify-between items-center  text-white cursor-pointer p-2 px-4  `} onClick={()=>setTab(1)}>
      ...
      <p className="text-xs">15 mins</p>
                    ...
                    <span className="text-secondary text-xl"><MdOutlineKeyboardArrowRight/></span>

                </div>
                <div className={` ${Tab==2?"border-l-2 border-l-secondary ":"border-none"} w-9/12 h-16 flex justify-between items-center  text-white cursor-pointer p-2 px-4  `} onClick={()=>setTab(2)}>
                    <div className="flex gap-x-2 items-center">
                   <span className="text-secondary "><FaRegCalendarAlt/> </span>
<p className="text-xs">Date,Time & consultant</p>
                ...
                <div className="flex justify-between items-center w-9/12 text-white cursor-pointer  p-2 px-4 ">
                    <div className="flex gap-x-2 items-center">
                   <span className="text-[#949393] "><FaRegUser/> </span>
<p className="text-xs text-[#949393]">Your info</p>
            ...
            <div className="w-full  ">
                <div className={`${Tab==1?"block":"hidden"}  flex justify-between bg-[#595959] p-2 px-4`}>
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="text-secondary"><FaRegCheckCircle/></span>
                    </div>
...
<h2 className="font-trebuchet text-2xl font-semibold text-center py-8">{text}</h2>
        ...
        <div className="container mx-auto mt-20 ">
           ...
           {Flex.map(({id,Img,head,lead})=>{
            return(
                ...
                transition={{ duration: 0.8 }}
                viewport={{once:true}}
                className={`${id%2===0?"lg:flex-row-reverse":""} gap-x-20 flex flex-col lg:flex-row items-center`}>
                    ...
                    <div className="font-trebuchet grid place-items-center text-start md:text-center  w-full lg:text-start space-y-4">
                        <h2 className="text-primary text-start text-xl  md:text-3xl font-semibold ">{head}</h2>
                        <p className="text-sm md:text-lg w-10/12 text-start md:text-center lg:text-start ">{lead}</p>
                    </div>
                </motion.div>
            )
           })}
      ...
      <section>
        ...
        <h2 className="text-primary text-2xl md:text-3xl font-trebuchet font-semibold text-center">SaaS Solutions We Offer
            </h2>
